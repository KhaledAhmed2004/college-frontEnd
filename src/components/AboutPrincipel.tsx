...
const AboutPrincipel = () => {
  return (
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-4 p-6">
      {/* Image Section */}
      ...
      {/* Content Section */}
      <div className="w-full md:w-[70%] bg-white border-2 shadow-md rounded-lg p-8">
        ...
        <p>
          ...
          needs. Established in 1921, the University of Dhaka has always been an
          integral part of the history of Bangladesh. In every critical juncture
          of the nation’s journey, be it the ...
        </p>
      </div>
    </div>
  );
